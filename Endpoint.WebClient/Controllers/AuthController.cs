...
namespace Endpoint.WebClient.Controllers
{
    public class AuthController : Controller
    {
        ...
        public async Task<IActionResult> LoginAsync(LoginViewModel login)
        {
            ...
            var response =  _client.PostAsync("/api/Auth/Post", content).Result; // In api Token midahad da sorat Login.
        ...
        public IActionResult Signup(SignUpViewModel request)
        {
            ...
            var content = new StringContent(jsonBody, Encoding.UTF8, "application/json");
            var response = _client.PostAsync("/api/Auth/Signup", content).Result; // In api Token midahad da sorat Login.
